export default function AboutBlock() {
  return (
    ...
    <div className="border-gray border relative bg-gray p-8 rounded-lg flex flex-col gap-2 ">
      <h2 className="text-4xl font-semibold relative">A developer who understands business</h2>
