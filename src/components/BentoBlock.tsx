    ...
    <div className="relative" id="about">
      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:grid-rows-2 ">
        ...
        <div className="relative lg:row-span-2">
          <div className="bg-fin-blue-lighter2 rounded-md relative flex h-full flex-col overflow-hidden">
            ...
            <div className="@container relative min-h-120 w-full grow max-lg:mx-auto max-lg:max-w-sm">
              <div className="absolute inset-x-0 top-12 -bottom-4 overflow-hidden  rounded-t-lg  ">
                ...
                <div className="pointer-events-none absolute inset-0 rounded-lg bg-gradient-to-b from-fin-blue-lighter2 via-fin-blue-lighter2/10 to-fin-blue-lighter2/0" />
                <Image
                  alt=""
        ...
        <div className="relative lg:row-span-1 lg:col-span-1 h-72">
          <div className="bg-fin-blue-lighter2 rounded-md relative flex h-full flex-col overflow-hidden">
            ...
            <div className="@container relative w-full grow max-lg:mx-auto max-lg:max-w-sm">
              <div className="absolute inset-x-0 bottom-0 overflow-hidden h-28">
          ...
          <div className="bg-fin-blue-lighter2 rounded-md relative flex h-full flex-col overflow-hidden">
            ...
            <div className="@container relative min-h-120 w-full grow max-lg:mx-auto max-lg:max-w-sm">
              <div className="absolute inset-x-0 top-12 -bottom-4 overflow-hidden  rounded-t-lg ">
                ...
                <div className="pointer-events-none absolute inset-0 rounded-lg bg-gradient-to-b from-fin-blue-lighter2 via-fin-blue-lighter2/50 to-fin-blue-lighter2/0" />
